...
class AdminController extends Controller
{
    ...
    public function databarangadmin(){
        $dataproduk = Produk::all();
        return view('admin.databarangadmin', compact('dataproduk'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.databarangadmin')->with('success', 'Data berhasil diupdate!');
    }
