...
class PetugasController extends Controller
{
    ...
    public function tambahbarang(){
        return view('petugas.tambahbarang');
    }

    public function databarang(){
        $dataproduk = Produk::all();
        return view ('petugas.databarang', compact('dataproduk'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('petugas.databarang')->with('success', 'Data berhasil diupdate!');
    }
    ...
    public function editbarang()
    {
        ...
        // dd($data->toArray());
      return view('petugas.editbarang', compact('data'));
    }
