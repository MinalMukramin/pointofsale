                            ...
                            <form class="form form-horizontal" action="{{ route('admin.store') }}" method="post">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <input type="number" id="level" name="level" value="2" hidden>
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="password" class="form-control"
                                                        placeholder="Password" id="password-horizontal-icon"
                                                        name="password">
                                                    <div class="form-control-icon">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped table " id="table1">
                                ...
                                <tbody>
                                    @foreach ($data as $d)
                                        <tr>
                                            <td>{{ $d->name == Auth::user()->name ? 'Display Account' : $d->name }}</td>
                                            <td>{{ $d->email }}</td>
                                            <td>{{ $d->level == 1 ? 'admin' : 'petugas' }}</td>
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="javascript:void(0)"
                                                    id="edit-barang" data-url="{{ route('admin.showuser', $d->id) }}"
                                                    data-bs-toggle="modal" data-bs-target="#edit">Edit</a>
                                                <a class="btn btn-sm btn-danger" href="{{ route('admin.destroyuser', $d->id)}}">Hapus</a>
                                            </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Data Barang <span
                                id="n-barang"></span></h1>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('admin.updateuser') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" name="level" id="level-user" hidden>
                            <div class="form-group">
                                <label for="basicInput">Nama user</label>
                                <input type="ztext" name="name" class="form-control" id="name-user"
